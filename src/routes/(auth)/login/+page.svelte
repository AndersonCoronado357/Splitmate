...
<div class="w-full">
	...
	<header class="animate-fade-in mb-4" style="animation-delay: 70ms">
		<h1 class="text-2xl font-bold tracking-tight text-text sm:text-3xl">Bienvenido de vuelta</h1>
		<p class="mt-1 text-sm text-muted">Entra para ver las cuentas de tu hogar.</p>
	</header>
	...
	>
		...
		<div class="space-y-1.5">
			<div class="flex items-baseline justify-between">
				...
				<a href="/recuperar" class="text-xs font-medium text-brand-700 hover:underline">
